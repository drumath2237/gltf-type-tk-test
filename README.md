...
- Vite 8.0.13
- Three.js 0.184.0
- gltf-type-toolkit 1.2.0

## Credits

### `assets/AntiqueCamera.glb`

[Source](https://github.com/KhronosGroup/glTF-Sample-Assets/blob/main/Models/AntiqueCamera/glTF-Binary/AntiqueCamera.glb)

- © 2018, UX3D. [CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/legalcode)
  - Maximillan Kamps for Everything
- © 2017, UX3D. [UX3D Trademark or Logo](https://github.com/KhronosGroup/glTF-Sample-Assets/blob/main/LICENSES/LicenseRef-LegalMark-UX3D.txt)
